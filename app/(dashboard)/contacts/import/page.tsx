...
export default function ImportContactsPage() {
  ...
  const downloadTemplate = () => {
    const csvContent = 'name,phone,email,tags,notes,sms_consent,marketing_consent\n' +
      'Anna Andersson,0701234567,anna@example.com,vip;stamkund,Älskar italiensk mat,true,true\n' +
      'Erik Johansson,0709876543,erik@example.com,restaurant,Besöker ofta på fredagar,true,false\n';
    ...
    try {
      ...
      for (let i = 0; i < contacts.length; i++) {
        ...
        const contactData = {
          ...
          tags: contact.tags ? contact.tags.split(';').map((t: string) => t.trim()).filter((t: string) => t) : [],
          custom_fields: contact.notes ? { notes: contact.notes } : {},
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <ul className="space-y-1 text-sm text-blue-800">
                ...
                <li><strong>marketing_consent</strong>: true eller false för marknadsföring (valfri, default: false)</li>
              </ul>
            </div>
