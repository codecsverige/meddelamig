...
export default function ImportContactsPage() {
  ...
  const downloadTemplate = () => {
    const csvContent = 'name,phone,email,tags,sms_consent,marketing_consent\n' +
      ...
      'Erik Johansson,0709876543,erik@example.com,restaurant,true,false\n';
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <ul className="space-y-1 text-sm text-blue-800">
                ...
                <li><strong>sms_consent</strong>: true eller false - SMS-påminnelser (obligatorisk)</li>
                <li><strong>marketing_consent</strong>: true eller false - Marknadsföring (valfri, default false)</li>
              </ul>
            </div>
